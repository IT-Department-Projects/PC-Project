...
mpirun -np 2 mpi 1_1024x1024_k30.txt out.txt 0.5 30
mpirun -np 2 mpi 1_1024x1024_k60.txt out.txt 0.5 60
mpirun -np 2 mpi 1_1024x1024_k90.txt out.txt 0.5 90
